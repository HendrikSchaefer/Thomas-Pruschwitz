			...
			meta = {[
				...
				link={[
					...
					<Aside>
						...
						<Navigator>
						<div><a href="/"><img style={{width:'110px', height:'auto', borderRadius:'100px', border:'solid #fafafa', marginBottom:'-30px'}} src="https://pbs.twimg.com/profile_images/980087743664541697/_XnBbr5H_400x400.jpg" alt="" /></a></div>
							<Logo><br/>
